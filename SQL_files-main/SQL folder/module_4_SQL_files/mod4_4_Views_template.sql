...
-- View Definition
	...
	--  Using Views in SQL Queries
		...
		/*  One view may be used in the expression defining another view.
			...
			CREATE VIEW comp_sci_spring_2004_watson AS
			SELECT course_id,room_number
			FROM comp_sci_spring_2004
			WHERE building='Power';
			
			DROP VIEW comp_sci_spring_2004_watson; 
			...
			FROM (SELECT course.course_id, sec_id,building,room_number
				...
				AND course.dept_name= 'Comp. Sci.'
				AND section.semester = 'Spring'
				AND section.year =2004) AS foobar
			WHERE building='Power';
...
--  Updation of View Relations
	...
	/*
			if above was succesful, then it would this:
			inserted into instructor:('69987','White',null,null)
			inserted into department:(null,'Taylor',null)
		*/
